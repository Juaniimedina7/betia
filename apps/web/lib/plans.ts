...
export const PLANS: Plan[] = [
  {
    ...
    cta: "Empezar gratis",
    features: [
      { label: "5 combos por mes", included: true },
      { label: "Historial de 3 combos", included: true },
  ...
  },
  {
    ...
    historyCap: 25,
    cta: "Elegir Starter",
    nudge: "40 combos rinden 1 o 2 findes fuertes. Después te quedás corto.",
    features: [
      { label: "40 combos por mes", included: true },
      { label: "Historial de 25 combos", included: true },
  ...
  },
  {
    ...
    badge: "Mejor valor",
    cta: "Pasarme a Pro",
    nudge: "15× los combos de Starter por apenas $15.000 más.",
    features: [
      { label: "600 combos por mes", included: true },
